...
# --- Ruta de tu dataset ---
DATA_DIR = "/lustre/proyectos/p032/datasets/images/tmp"

# --- Crear el transform SimCLR con tu normalización real ---
...
if __name__ == "__main__":
    ...
    print("Iniciando Entrenamiento con 100 epocas")
    start_time = time.time() 
    # --- 6. Entrenamiento ---
    trainer.fit(model, dataloader)
    end_time = time.time()     # marca fin
